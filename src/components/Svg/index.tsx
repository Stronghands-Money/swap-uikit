...
export { default as BinanceIcon } from "./Icons/Cronos";
...
export { default as StronghandsIcon } from "./Icons/Stronghands";
export { default as StronghandsRoundIcon } from "./Icons/StronghandsRound";
